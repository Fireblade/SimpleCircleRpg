...
public class LevelsNoise {
	...
	public static boolean pullNewPreset(boolean[][] tiles, int width, int height, Point pnt, Queue<Point> que,
		...
		while (cycles < cycleLimit) {
			...
			case 0:
				if (x + 5 < width - 1 && y - 5 > 0 && y + 6 < height - 1) {
					tiles[x + 0][y - 5] = true;
					tiles[x + 2][y - 5] = true;
					tiles[x + 3][y - 5] = true;
					tiles[x + 4][y - 5] = true;
			...
			case 3:
				if (x + 11 < width - 1 && y - 6 > 0 && y + 6 < height - 1) {
					tiles[x + 3][y - 6] = true;
					tiles[x + 5][y - 6] = true;
					tiles[x + 6][y - 6] = true;
					tiles[x + 7][y - 6] = true;
			...
			case 6:
				if (x + 14 < width - 1 && y - 3 > 0 && y + 3 < height - 1) {
					tiles[x + 0][y - 3] = true;
					tiles[x + 1][y - 3] = true;
					tiles[x + 2][y - 3] = true;
					tiles[x + 3][y - 3] = true;
			...
			case 7:
				if (x + 8 < width - 1 && y - 1 > 0 && y + 7 < height - 1) {
					tiles[x + 0][y - 1] = true;
					tiles[x + 1][y - 1] = true;
					tiles[x + 2][y - 1] = true;
					tiles[x + 3][y - 1] = true;
