...
public class LevelsLine {
	...
	public static boolean pullNewPreset(boolean[][] tiles, int width, int height, Point pnt, Queue<Point> que,
		...
		while (cycles < cycleLimit) {
			...
			case 2:
				if (x + 6 < width - 1 && y - 0 > 0 && y + 4 < height - 1) {
					tiles[x + 0][y + 0] = true;
					tiles[x + 1][y + 0] = true;
					tiles[x + 4][y + 0] = true;
					tiles[x + 5][y + 0] = true;
			...
			case 3:
				if (x + 5 < width - 1 && y - 2 > 0 && y + 6 < height - 1) {
					tiles[x + 0][y - 2] = true;
					tiles[x + 1][y - 2] = true;
					tiles[x + 2][y - 2] = true;
					tiles[x + 0][y - 1] = true;
			...
			case 4:
				if (x + 5 < width - 1 && y - 2 > 0 && y + 1 < height - 1) {
					tiles[x + 3][y - 2] = true;
					tiles[x + 4][y - 2] = true;
					tiles[x + 5][y - 2] = true;
					tiles[x + 3][y - 1] = true;
			...
			case 5:
				if (x + 5 < width - 1 && y - 2 > 0 && y + 2 < height - 1) {
					tiles[x + 3][y - 2] = true;
					tiles[x + 4][y - 2] = true;
					tiles[x + 0][y - 1] = true;
					tiles[x + 1][y - 1] = true;
			...
			case 6:
				if (x + 15 < width - 1 && y - 4 > 0 && y + 3 < height - 1) {
					tiles[x + 3][y - 4] = true;
					tiles[x + 4][y - 4] = true;
					tiles[x + 5][y - 4] = true;
					tiles[x + 2][y - 3] = true;
			...
			case 7:
				if (x + 5 < width - 1 && y - 3 > 0 && y + 0 < height - 1) {
					tiles[x + 4][y - 3] = true;
					tiles[x + 5][y - 3] = true;
					tiles[x + 0][y - 2] = true;
					tiles[x + 1][y - 2] = true;
